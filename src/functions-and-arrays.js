...
function sum(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    if (typeof arr[i] == "string") {
      somaDeNaoNumeros += arr[i].length;
    }
  }
  return somaDeNaoNumeros + resultado;
}
...
function avg(arr) {
  ...
  return (somaDeNaoNumeros + resultado) / arr.length;
}
...
//console.log(doesWordExist(wordsFind,'laranja'))
